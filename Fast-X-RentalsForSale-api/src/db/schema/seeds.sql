...
VALUES
  (1, 'Toyota', 'Corolla', 20000, 15000.00, 2018, 'Blue', ARRAY['image1.jpg'], true, false),
  (2, 'Honda', 'Civic', 30000, 18000.00, 2019, 'Black', ARRAY['image3.jpg'], true, false),
  (3, 'Ford', 'Fusion', 25000, 17000.00, 2020, 'White', ARRAY['image5.jpg'], true, false),
  (4, 'Chevrolet', 'Malibu', 28000, 19000.00, 2019, 'Silver', ARRAY['image7.jpg'], true, false),
  (2, 'Toyota', 'Camry', 15000, 16000.00, 2021, 'Red', ARRAY['image9.jpg'], true, true);
